...
@RestController
@RequestMapping("/api/declaccise-kafka")
public class DeclacciseKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DeclacciseKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DeclacciseKafkaResource(KafkaProperties kafkaProperties) {
